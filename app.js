const songsData = [
    {
        ...
        lyrics: `A esquadrilha é um punhado de amigos,
...
Lutaremos, morreremos
Pela bandeira do BrasilEntre as nuvens, nos
céus, vendo a terra
...
Seus feitos marcantes são flagrantes na
memória
Salve a Patrulha, Salve a Patrulha!
A Embarcada retrata sua força, sua glória
Empunhando o tridente mortal, na
defesa da Força Naval
Em vigília constante, protege o mercante
e nosso litoral

Atravessa o oceano, buscando o tirano
escondido no fundo do mar
Não importa a tormenta, se chove ou se
venta, ela tem um caminho a trilhar
Avante, Cardeais! Audazes, não recuam
jamais
Quer na paz ou na guerra, operando de
terra ou de bordo de Porta Aviões
Sua força irradia, de noite ou de dia,
enfrentando quaisquer condições
Da Pátria são zelosos guardiões
Lutando sem descanso pela paz entre as
nações
...
Sob o céu deste grande Brasil.`
    },
    {
        ...
        lyrics: `Instruir, treinar, inspirar,
...
Excelência no ensino Da Força Aérea Brasileira.
Formando e adaptando Oficiais para comandar,
...
A glória do meu Brasil`
    },
    {
        ...
        lyrics: `Infantaria, serás sempre altaneira!

Teus soldados, tu bem sabes escolher
Com heroísmo, tu defendes a Bandeira
Honrando a Pátria que herdaste ao
nascer
...
É o Brasil o teu berço, o teu chão`
    },
    {
        ...
        lyrics: `Da busca, o alerta, a mensagem
...
Da perspicácia a coragem audaz
...
function openPlayer(song) {
    ...
    if (htmlAudioPlayer) {
        htmlAudioPlayer.src = song.audioUrl || '';
    }

    if (htmlPdfPlayer) {
        htmlPdfPlayer.src = song.pdfUrl || '';
    }
